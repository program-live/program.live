        ...
        projects.map((project: OpenSourceProject, i: number) => (
          <li key={i} className="group">
            ...
            >
              ...
              <span className="inline-flex gap-4 items-center whitespace-nowrap flex-shrink-0"><StarFilledIcon className="size-8 opacity-80 group-hover:text-black" /> {project.stars}</span>
            </Link>
          </li>
        ))
      )}
